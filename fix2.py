...
b = 'lt+"prop.list"+gt+nl+lt+"prop.pair"+gt+nl+lt+"key"+gt+"Stops List"+lt+"key"+gt+nl;'
f = 'lt+"prop.list"+gt+nl+lt+"prop.pair"+gt+nl+lt+"key"+gt+"Stops List"+lt+"/key"+gt+nl;'
